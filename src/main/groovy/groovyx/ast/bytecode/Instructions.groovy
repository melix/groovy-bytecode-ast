...
class Instructions {
    ...
    /**
     * Contains the list of JVM instructions which accept a single argument
     */
    public static Set<String> UNARY_OPS = [
            "aload",
            "anewarray",
            "astore",
            "bipush",
            ...
            "ifnull",
            "iload",
            "_instanceof", // should be "instanceof"
            "istore",
//            "jsr", // deprecated
            "ldc",
            "lload",
